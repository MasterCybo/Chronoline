...
//			_info.addChild( _tfProgress );
			...
			var animLoader:AMovieClipContainer = AMovieClipContainer.fromClass( MCLoaderAnim ).init();
			animLoader.x = int( Display.stageWidth / 2 );
			animLoader.y = _info.y + _info.height + 10;
